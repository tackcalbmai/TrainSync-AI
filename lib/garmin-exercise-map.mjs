...
export const GARMIN_FIT_PROFILE_VERSION = "21.213.0";
export const GARMIN_EXERCISE_MAP_VERSION = "fit-21.213.0+trainsync-2026-08-23.1";
...
// IDs/names are pinned to Garmin FIT Profile 21.213.0. A TrainSync exercise is mapped only
...
export function getGarminExerciseMapping(exerciseKey) {
  ...
  return GARMIN_EXERCISE_MAP[definition.key] || Object.freeze({
    ...
    exerciseName:null,
    match:"unmapped",
    notes:"No defensible Garmin FIT Profile 21.213.0 exercise mapping is registered. Preserve the TrainSync step name and do not invent an exercise_category/exercise_name pair.",
  });
}
