export const EXERCISE_CATALOG_VERSION = "2026-08-23.1";
...
export const EXERCISE_CATALOG = Object.freeze(Object.fromEntries(rawCatalog.map((item) => [item.key, Object.freeze({
  ...
  secondaryMuscles: Object.freeze([...(item.secondaryMuscles || [])]),
...
export function canonicalizeExerciseSelection(selection) {
  ...
  return {
    ...
    setMetric: selection?.setMetric || definition.defaultSetMetric,
