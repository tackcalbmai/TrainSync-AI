...
export function garminFitProjectionReadiness(workout = {}) {
  ...
  return {
    ready:summary.rangeTargetSets === 0 && summary.canonicalSets === summary.workSetCount,
    reasonCode:summary.rangeTargetSets > 0
      ? "TARGET_RANGE_PROVIDER_POLICY_REQUIRED"
      : summary.canonicalSets < summary.workSetCount
