...
export const SCIENCE_VERSION = "2026-09-01.1";
...
export const CLAIMS = Object.freeze({
  ...
  fractional_direct_indirect_sets: Object.freeze({
    statement: "In study-level dose-response meta-regression, distinguishing direct and indirect sets and assigning partial credit to indirect work fit the available hypertrophy and strength data better than counting every involved muscle as receiving a full direct set.",
    confidence: "moderate",
    outcomes: ["hypertrophy", "strength"],
    sourceIds: ["pelland_2026_dose_response"],
    applicability: "Useful as a population-level dose-estimation model. It does not establish that every secondary muscle receives exactly one-half of a direct set, and exercise-specific fractions remain a product approximation.",
  }),
...
export const RULE_EVIDENCE_BINDINGS = Object.freeze({
  fractionalSecondarySet: Object.freeze({ kind: "evidence_informed_heuristic", level: "moderate", claimIds: ["fractional_direct_indirect_sets"], note: "0.5 is a useful study-level fractional model from the cited dose-response analysis, not a universal exercise-muscle conversion law." }),
