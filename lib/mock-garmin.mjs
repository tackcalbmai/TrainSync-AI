...
export function getMockConnectionStatus() {
  return {
    ...
    mockReady: true,
    officialCredentialsConfigured: false,
    capabilities: ["strength_workouts", "calendar_publish", "training_plans"],
    message: "Mock Garmin provider is active for local projection/testing only. No official Garmin account is connected and no external Garmin account is modified.",
  };
}
